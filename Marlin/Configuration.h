...
#define STRING_CONFIG_H_AUTHOR "pavluke" // Who made the changes.
 ...
 */
  ...
  #define MPC_SENSOR_RESPONSIVENESS { 0.5226f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0577f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1023f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
  ...
  #define FILAMENT_HEAT_CAPACITY_PERMM { 0.0036f }    // 0.0056 J/K/mm for 1.75mm PLA (0.0149 J/K/mm for 2.85mm PLA).
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 49.28
  #define DEFAULT_BED_KI 9.85
  #define DEFAULT_BED_KD 164.44
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 1600, 680 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 5000, 5000, 1000, 120 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 10000, 10000, 1500, 120 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 6000, 6000, 50, 800 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 12000, 12000, 50, 800 } // ...or, set your own edit limits
#endif
...
//#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 15, 15, 0.3, 10 } // ...or, set your own edit limits
  #endif
#endif
...
#define NOZZLE_TO_PROBE_OFFSET { 29, -20.5, 0 }
...
#define Z_CLEARANCE_BETWEEN_PROBES  Z_CLEARANCE_DEPLOY_PROBE // (mm) Z Clearance between probe points
